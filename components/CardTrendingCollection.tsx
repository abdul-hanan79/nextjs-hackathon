                ...
                <Card.Body className='p-1 pt-3 card-body'>
                    <Row className="gap-0">
                        <Col lg={4} md={4} sm={4} xs={4} className="">
                            <Image src={props.secondaryImg1} height="90px" widht="90px" className='img-fluid' alt="image" />
                        </Col>
                        <Col lg={4} md={4} sm={4} xs={4} className="">
                            <Image src={props.secondaryImg2} height="90px" widht="90px" alt="image" className='img-fluid' />
                        </Col>

                        <Col lg={4} md={4} sm={4} xs={4} className="">
                            <Image src={props.secondaryImg3} height="90px" widht="90px" alt="image" className='img-fluid' />
                        </Col>
                    </Row>
                    <Card.Title className='mt-3'>{props.title}</Card.Title>
                    <Card.Text className="mt-2">
                        <Image src={props.avatarPlaceholder} alt="avatar" height={24} width={24} /> <span className='cards-text'>{props.text}</span>
                    </Card.Text>
